...
const IndexPage = () => (
  <Layout>
    ...
    <p className={styles.list}>
      {links.map(link => (
        <p key={link.url} className={styles.listItem}>
          <a
